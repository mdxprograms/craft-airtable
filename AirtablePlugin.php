...
class AirtablePlugin extends BasePlugin
{
    ...
    {
        return Craft::t('Use Airtable bases in Craft');
    }
    ...
    {
        return 'https://www.joshwaller.me';
    }
    ...
    {
        return array(
            'api_key' => array(AttributeType::String, 'label' => 'API key', 'default' => ''),
            'basesAndTables' => array(AttributeType::String, 'label' => 'Bases and Tables', 'default' => ''),
        );
    }
